                ...
                <?php foreach (mdm\admin\components\MenuHelper::getAssignedMenu(\Yii::$app->user->id) as $key=>$group) : ?>
                    <li>
                        <?php if(!empty($group['items'])): ?>
                            <a href="#"> <?= $group['label']?><span class="glyphicon glyphicon-menu-down pull-right"></span></a>
                        <?php else: ?>
                            <a href="<?= \yii\helpers\Url::toRoute($group['url']) ?>" class="J_menuItem"> <?= $group['label']?></a>
                        <?php endif; ?>
                        <ul class="nav nav-second-level">
                            <?php if(!empty($group['items'])): ?>
                                <?php foreach ($group['items'] as $menu) : ?>
                                    <li>
                                        <a href="<?= \yii\helpers\Url::toRoute($menu['url']) ?>" class="J_menuItem"> <?= $menu['label']?></a>
                                    </li>
                                <?php endforeach; ?>
                            <?php endif; ?>
                        </ul>
